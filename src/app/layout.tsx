    ...
    <html lang="en">
      <header>
        ...
        <meta
          ...
          content="Đình Văn & Lan Anh - Our wedding date: 2025-03-07 | Tôi yêu bạn vì tất cả những gì bạn đang có, tất cả những gì bạn đã có, và tất cả những gì bạn chưa hiện hữu"
        />
        <meta property="og:image" content="/damcuoine/image/IMG_avatar.jpg" />
        <meta property="og:image:url" content="/damcuoine/image/IMG_avatar.jpg" />
        <meta property="og:image:secure_url" content="/damcuoine/image/IMG_avatar.jpg" />
        <link
